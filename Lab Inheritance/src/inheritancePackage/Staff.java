...
public class Staff {
	...
	public Staff() {
		...
		staffList[6] = new Commission("James Madison", "Mont Pelier", "202-538-7649", "235-71-1131", 6.25, .2);
		staffList[7] = new Commission("George Washington", "Mount Vernon", "703-799-8691", "314-15-9265", 9.75, .15);
